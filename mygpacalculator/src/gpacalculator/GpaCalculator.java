...
public class GpaCalculator {
    ...
    System.out.print("Enter credit5: ");
        ...
        st.displayRecord(course2, credit2, grade2, point2);
        st.displayRecord(course3, credit3, grade3, point3);
        st.displayRecord(course4, credit4, grade4, point4);
        st.displayRecord(course5, credit5, grade5, point5);
